...
\begin{enumerate}
  \item Exportera en png-karta med tillhörande pgw-fil från OOM
  \item Ladda ner motsvarande laserdata och ytmodell
  \item Kör \verb|las_data_prep.R| för att sammanfoga data
  \item Kör \verb|pvcnn/data/terrain/prepare_data.py| för att skapa h5-filer
  \item Kör \verb|pvcnn/train.py| för att träna modellen.
\end{enumerate}
...
\begin{enumerate}
  \item Exportera en png-karta med tillhörande pgw-fil från OOM ELLER
  \item Skapa en .png-fil och .pgw-fil manuellt om orienteringskarta saknas. \footnote{Kan vara enfärgad, men antalet pixlar samt värdena i .pgw-filen avgör hur griddningen och därmed kartorna görs.}
  \item Ladda ner motsvarande laserdata och ytmodell
  \item Kör \verb|las_data_prep.R| för att sammanfoga data
  \item Kör \verb|pvcnn/data/terrain/prepare_data.py| för att skapa h5-filer
  \item Se till att 
  \item Kopiera in xyzrgb-filerna till h5-katalogen med \verb|pvcnn/utils/xyzrgbcopy.py|
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Kör \verb|las_data_prep.R| för att sammanfoga data
  \item Kör \verb|pvcnn/data/terrain/prepare_data.py| för att skapa h5-filer
  \item Kopiera in label-filerna till h5-katalogen med \verb|pvcnn/utils/labelbcopy.py| 
\end{enumerate}